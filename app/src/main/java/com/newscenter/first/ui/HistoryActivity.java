...
@Route(path = "/center/HistoryActivity")
@ContentView(R.layout.activity_history)
public class HistoryActivity extends BaseActivity<BaseViewModel> {
    ...
    public void initView(ViewDataBinding viewDataBinding) {
        ActivityHistoryBinding binding = (ActivityHistoryBinding) viewDataBinding;
        ...
        mAdapter = new HistoryAdapter(mNewsList);
...
//                        .setHeaderClickListener(clickAdapter)
                        .create());
        mRvList.addItemDecoration(new RecycleViewDivider(HistoryActivity.this, LinearLayoutManager.VERTICAL));
        mRvList.setLayoutManager(new LinearLayoutManager(HistoryActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    protected void initEvent() {
            ...
            public void SearchAciton(String string) {
                ...
                for (;iterator.hasNext();){
                    ...
                    if (next.getItemType() == 1){
                        HistoryNewsSon son = (HistoryNewsSon) next;
        ...
        mAdapter.setOnBoxSelectListener(new HistoryAdapter.onCheckboxSelectListener() {
            @Override
            public void onSelect(int position) {
                count++;
                HistoryNewsSon son = (HistoryNewsSon) mNewsList.get(position);
                son.setChecked(true);
            ...
            public void onClick(View view) {
                ...
                for (MultiItemEntity son:mNewsList){
                    if (son.getItemType() == 1){
                        HistoryNewsSon itemEntity = (HistoryNewsSon) son;
            ...
            public void onClick(View view) {
                ...
                for (Iterator<News> iterator = mNewsJson.iterator();iterator.hasNext();){
                    ...
                    for (;iterator1.hasNext();){
                        ...
                        if (son.getItemType() ==1 &&((HistoryNewsSon)son).isChecked()&&next.getTitle().equals(((HistoryNewsSon)son).getTitle())){
                            iterator.remove();
                            iterator1.remove();
                        }
                    }
        ...
        if (!CommonUtil.isStrEmpty(json)){
            ...
            try {
                ...
                for (String time:datePeriod){
                    HistoryNewsParent parent = new HistoryNewsParent();
                    ...
                    for (News news: mNewsJson){
                        if (news.getHistoryDate().equals(time)){
                            HistoryNewsSon son = new HistoryNewsSon();
